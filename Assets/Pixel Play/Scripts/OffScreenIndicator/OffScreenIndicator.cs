...
public class OffScreenIndicator : MonoBehaviour {
    ...
    [Range(0.5f, 0.9f)] [Tooltip("Distance offset of the indicators from the centre of the screen")] [SerializeField]
    ...
    private void DrawIndicators() {
        foreach (var target in targets) {
            ...
            if (target.NeedBoxIndicator && isTargetVisible) {
                ...
                OffScreenIndicatorCore.GetArrowIndicatorPositionAndAngle(ref screenPosition, ref angle, screenCentre,
                    screenBounds);
                indicator = GetIndicator(ref target.indicator,
