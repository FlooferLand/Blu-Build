        ...
        if (valveMapping > 0) {
            for (int i = 0; i < programmingGroups.recordingGroups[valveMapping - 1].inputNames.Length; i++)
                if (programmingGroups.recordingGroups[valveMapping - 1].inputNames[i].index[0] > 0) {
                    ...
                    if (invertcooldown > 0) invertcooldown--;
                    ...
                    if (keypadInvert[i]) applyKey = !applyKey;
                    if (Input.GetKey(KeyCode.LeftControl) && invertcooldown != 0) applyKey = false;
                    ...
                    if (!programmingGroups.recordingGroups[valveMapping - 1].inputNames[i].drawer) {
                        ...
                        if (applyKey) {
                            ...
                            for (int e = 0;
                                 e < programmingGroups.recordingGroups[valveMapping - 1].inputNames[i].index.Length;
                                 e++)
                                frameInputs.topDrawer[
                                        programmingGroups.recordingGroups[valveMapping - 1].inputNames[i].index[e] -
                                        1] =
                                    true;
                        }
                    }
